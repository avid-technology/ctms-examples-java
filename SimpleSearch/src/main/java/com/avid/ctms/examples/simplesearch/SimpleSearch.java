...
import com.avid.ctms.examples.tools.V2.PlatformToolsV2;
...
public class SimpleSearch {
    ...
    public static void main(String[] args) throws Exception {
        if (false) {
            ...
            final String rawSearchExpression = "";

            PlatformToolsV2.authorize("mun-docker-ml.showroom.local", "Y29tLmF2aWQubWVkaWFjb21wb3Nlci00Y2I2NjQ5MTUyNjE1YWMyNDQ4OTU1NjZmMTMzY2Y3Njo2YzMxNTliYmI4MjA0YjEwYjk1OGY5NDJiYmMwNGQyMDk1N2EwMTRlZGFlMTRlYjFkOTdkYzdmNWUwNWY1MWY1",
                    "Administrator",
                    "Avid123");
            final boolean successfullyAuthorized = PlatformTools.authorize("mun-docker-ml.showroom.local", "Administrator", "Avid123");
            if (args.length != 0) {
